...
PG_KEYWORD("access_key_id", ACCESS_KEY_ID, UNRESERVED_KEYWORD)
PG_KEYWORD("action", ACTION, UNRESERVED_KEYWORD)
PG_KEYWORD("add", ADD_P, UNRESERVED_KEYWORD)
PG_KEYWORD("addquotes", ADDQUOTES, UNRESERVED_KEYWORD)
...
PG_KEYWORD("allowoverwrite", ALLOWOVERWRITE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("bzip2", BZIP2, UNRESERVED_KEYWORD)
...
PG_KEYWORD("compound", COMPOUND, UNRESERVED_KEYWORD)
...
PG_KEYWORD("credentials", CREDENTIALS, UNRESERVED_KEYWORD)
...
PG_KEYWORD("distkey", DISTKEY, RESERVED_KEYWORD)
PG_KEYWORD("diststyle", DISTSTYLE, RESERVED_KEYWORD)
...
PG_KEYWORD("encode", ENCODE, RESERVED_KEYWORD)
...
PG_KEYWORD("fixedwidth", FIXEDWIDTH, UNRESERVED_KEYWORD)
...
PG_KEYWORD("gzip", GZIP, UNRESERVED_KEYWORD)
PG_KEYWORD("handler", HANDLER, UNRESERVED_KEYWORD)
PG_KEYWORD("having", HAVING, RESERVED_KEYWORD)
PG_KEYWORD("header", HEADER_P, UNRESERVED_KEYWORD)
PG_KEYWORD("hold", HOLD, UNRESERVED_KEYWORD)
PG_KEYWORD("hour", HOUR_P, UNRESERVED_KEYWORD)
PG_KEYWORD("iam_role", IAM_ROLE, UNRESERVED_KEYWORD)
PG_KEYWORD("identity", IDENTITY_P, UNRESERVED_KEYWORD)
PG_KEYWORD("if", IF_P, UNRESERVED_KEYWORD)
PG_KEYWORD("ignoreheader", IGNOREHEADER, UNRESERVED_KEYWORD)
...
PG_KEYWORD("interleaved", INTERLEAVED, UNRESERVED_KEYWORD)
...
PG_KEYWORD("manifest", MANIFEST, RESERVED_KEYWORD)
PG_KEYWORD("mapping", MAPPING, UNRESERVED_KEYWORD)
PG_KEYWORD("match", MATCH, UNRESERVED_KEYWORD)
PG_KEYWORD("materialized", MATERIALIZED, UNRESERVED_KEYWORD)
PG_KEYWORD("max", MAX, UNRESERVED_KEYWORD)
PG_KEYWORD("maxfilesize", MAXFILESIZE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("secret_access_key", SECRET_ACCESS_KEY, UNRESERVED_KEYWORD)
...
PG_KEYWORD("session_token", SESSION_TOKEN, UNRESERVED_KEYWORD)
...
PG_KEYWORD("sortkey", SORTKEY, RESERVED_KEYWORD)
...
PG_KEYWORD("unload", UNLOAD, RESERVED_KEYWORD)
